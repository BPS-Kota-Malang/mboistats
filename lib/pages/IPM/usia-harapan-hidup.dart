...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Usia Harapan Hidup</title>
    ...
    <script>
			var data;
			url='https://webapi.bps.go.id/v1/api/list/model/data/domain/3573/var/283/key/9db89e91c3c142df678e65a78c4e547f';
    ...
    <body style="background-image: url(file:///android_res/drawable/back_ipm.png); background-size: 100% 100%;">
        <div class="container" >
            <script> 
			if(satuanB == ""){
				document.write('<p align= "center" style="color:#843C0C; font-weight: bold;">USIA HARAPAN HIDUP (UHH)<br>'+ kolomB[0].toUpperCase() + ', ' + kolomB[1].toUpperCase() +', DAN ' + kolomB[2].toUpperCase() +'</p>'); 
			}
			else{
				document.write('<p align= "center" style="color:#843C0C; font-weight: bold;">USIA HARAPAN HIDUP (UHH)<br>'+ kolomB[0].toUpperCase() + ', ' + kolomB[1].toUpperCase() +', DAN ' + kolomB[2].toUpperCase() +'<br>(' + satuanB + ')</p>'); 
			}
			...
			<table border = "0" align ="center" style="width:auto; background-color:transparent;" cellpadding="10">
				<td>
					<div class="kotak"><p style="margin: 2px 2px 2px 2px;font-size:12px;color:#843C0C; text-align:center;" align="center"><b>USIA HARAPAN HIDUP (UHH)</b><br>
						<text style="color:#7F6000; font-size:12px; text-align:center;" align="center">merupakan rata-rata perkiraan banyaknya tahun yang dapat ditempuh oleh seseorang sejak lahir hingga akhir hidupnya</text></p>
					</div>
				</td>
			</table>
