...
<html lang="en">
    ...
    <script>
			var data;
			url='https://webapi.bps.go.id/v1/api/list/model/data/domain/3573/var/426/key/9db89e91c3c142df678e65a78c4e547f';
    ...
    <body style="background-image: url(file:///android_res/drawable/back_kesejahteraan.png); background-size: 100% 100%;">
        <div class="container" >
            <script> 
				if(satuanB == ""){
					document.write('<p align= "center" style="color:rgb(119, 99, 8); font-weight: bold;">GINI RASIO<br>'+ kolomB[0].toUpperCase() + ', ' + kolomB[1].toUpperCase() +', DAN ' + kolomB[2].toUpperCase() +'</p>'); 	
				}
				else{
					document.write('<p align= "center" style="color:rgb(119, 99, 8); font-weight: bold;">GINI RASIO<br>'+ kolomB[0].toUpperCase() + ', ' + kolomB[1].toUpperCase() +', DAN ' + kolomB[2].toUpperCase() +'<br>('+ satuanB +')</p>');
				}
			</script>
			...
			<table border = "0" align ="center" style="width:auto; background-color:transparent;" cellpadding="10">
				<td>
					<div class="kotak"><p style="margin: 2px 2px 2px 2px;font-size:12px;color:#776308;text-align:center;" align="center"><b>GINI RASIO</b><br>
						<text style="color:#776308; font-size:12px; text-align:center;" align="center">merupakan indikator untuk melihat ketimpangan pendapatan/pengeluaran penduduk di suatu wilayah</text></p>
					</div>
				</td>
			</table>
