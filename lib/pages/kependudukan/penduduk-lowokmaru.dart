...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Penduduk Lowokwaru</title>
    ...
    <script>
			var data;
			url='https://webapi.bps.go.id/v1/api/list/model/data/domain/3573/var/56/key/9db89e91c3c142df678e65a78c4e547f';
    ...
    <body style="background-image: url(file:///android_res/drawable/back_kependudukan.png); background-size: 100% 100%;">
        <div class="container" >
                ...
                <tr id="chart" align ="center" style="width:50%; text-align:center; height:15px;" >
                    <script>
							 var options = {
							  ...
							  {
								name: kolomD[0],
                                data: [valData[(pjData*1)-1], valData[(pjData*4)-1], valData[(pjData*7)-1], valData[(pjData*10)-1], valData[(pjData*13)-1], valData[(pjData*16)-1], valData[(pjData*19)-1], valData[(pjData*22)-1], valData[(pjData*25)-1], valData[(pjData*28)-1], valData[(pjData*31)-1], valData[(pjData*34)-1]]
							  },
							  {
								name: kolomD[1],
                                data: [valData[(pjData*2)-1], valData[(pjData*5)-1], valData[(pjData*8)-1], valData[(pjData*11)-1], valData[(pjData*14)-1], valData[(pjData*17)-1], valData[(pjData*20)-1], valData[(pjData*23)-1], valData[(pjData*26)-1], valData[(pjData*29)-1], valData[(pjData*32)-1], valData[(pjData*35)-1]]
							  }
							],
							  chart: {
							  height: 400,
							...
							xaxis: {
                              categories:[kolomB[0].toUpperCase(), kolomB[1].toUpperCase(), kolomB[2].toUpperCase(), kolomB[3].toUpperCase(), kolomB[4].toUpperCase(), kolomB[5].toUpperCase(), kolomB[6].toUpperCase(), kolomB[7].toUpperCase(), kolomB[8].toUpperCase(), kolomB[9].toUpperCase(), kolomB[10].toUpperCase(), kolomB[11].toUpperCase()],
							  labels: {
								show: false,
								style:{
									fontSize: '9px',
			...
			<table border = "0" align ="center" style="width:380px;background-color:transparent; font-size:10px; color:rgb(5, 44, 75);"cellpadding="10">
                ...
                <tr style="background-color:#d6d9e4; font-weight:bold;">
                    <script>
						document.write('<td>' + kolomB[11].toUpperCase() + '</td>');
						document.write('<td align="center">' + new Intl.NumberFormat('ID',{ minimumSignificantDigits: 2 }).format(valData[(pjData*34)-1]) + '</td>');
                        document.write('<td align="center">' + new Intl.NumberFormat('ID',{ minimumSignificantDigits: 2 }).format(valData[(pjData*35)-1]) + '</td>');
                        document.write('<td align="center">' + new Intl.NumberFormat('ID',{ minimumSignificantDigits: 2 }).format(valData[(pjData*36)-1]) + '</td>');
					</script>
                </tr>
