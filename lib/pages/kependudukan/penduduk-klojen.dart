...
class PendudukKlojenPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Penduduk Kecamatan Klojen'),
      ),
      body: WebView(
...
<html lang="en">
    ...
    <script>
			var data;
			url='https://webapi.bps.go.id/v1/api/list/model/data/domain/3573/var/54/key/9db89e91c3c142df678e65a78c4e547f';
