...
class PengangguranMenurutPendidikanPage extends StatelessWidget {
  @override
...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Penganggur Menurut Pendidikan</title>
    ...
    <script>
			var data,i;
			url='https://webapi.bps.go.id/v1/api/list/model/data/domain/3573/var/444/key/9db89e91c3c142df678e65a78c4e547f';
	...
	/*		alert(valData[Number(0*(pjThData)*pjKolom+8)] +" "+Number(0*(pjThData)*pjKolom+8));
			...
			alert(valData[Number(2*(pjThData)*pjKolom+8)] +" "+Number(2*(pjThData)*pjKolom+8)); */
    ...
    <body style="background-image: url(file:///android_res/drawable/back_ketenagakerjaan.png); background-size: 100% 100%;">
        <div class="container" align ="center" >
            <script>
				document.write('<p align= "center" style="color:#2F5597; font-weight: bold;">PENGANGGUR MENURUT<br>PENDIDIKAN TAHUN '+ thB[pjThData-1] +'<br>'+ kolomB[0].toUpperCase() + ', ' + kolomB[1].toUpperCase() +', DAN ' + kolomB[2].toUpperCase()+'</p>'); 
			</script>
							...
							tooltip: {
							  ...
							  y: {
								  formatter: function(value){
									return new Intl.NumberFormat('ID',{ minimumSignificantDigits: 2 }).format(Number(value)) + ' ' + satuanB
								  }
							  },
							  z: {
								show: false,
			...
			<table border = "0" align ="center" style="width:auto; background-color:transparent;" cellpadding="10">
				<td>
					<div class="kotak"><p style="margin: 2px 2px 2px 2px;font-size:12px;color:#2F5597; text-align:center;" align="center"><b>PENGANGGUR TERBUKA</b><br>
						<text style="color:#2F5597; font-size:12px; text-align:center;" align="center">merupakan penduduk usia 15 tahun ke atas yang tak punya pekerjaan dan mencari pekerjaan, tak punya pekerjaan dan mempersiapkan usaha, tak punya pekerjaan dan tidak mencari pekerjaan, karena merasa tidak mungkin mendapatkan pekerjaan, serta yang sudah punya pekerjaan, tetapi belum mulai bekerja</text></p>
					</div>
				</td>
			</table>
			<table border = "0" align ="center" style="width:auto; background-color:transparent;" cellpadding="10">
				<td>
					<script> 
						document.write('<p align= "center" style="color:#2F5597; font-weight: bold;">PERSENTASE PENGANGGUR '+ kolomB[0].toUpperCase() + '<br>MENURUT PENDIDIKAN</p>'); 
					</script>
				</td>
			</table>
